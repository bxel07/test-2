<x-app-layout>
    <div class="max-w-7xl mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <a href="{{ route('user.batch') }}" class="btn btn-primary">Download All as ZIP</a>
                    ...
                    @foreach($documents as $document)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap flex space-x-2 items-center">
                                ...
                                <a href="{{ route('user.excel', ['id' => $document->id]) }}" class="text-blue-500 hover:text-blue-700 text-sm" title="Export to Excel">
                                    <i class="fas fa-file-excel text-lg"></i>
                                </a>

                                <!-- Export to PDF Button -->
                                <a href="{{ route('user.pdf', ['id' => $document->id]) }}" class="text-green-500 hover:text-green-700 text-sm" title="Export to PDF">
